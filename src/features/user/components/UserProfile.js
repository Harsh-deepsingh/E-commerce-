    ...
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <p className="mt-0.5 text-sm text-gray-500 mb-4">Your Addresses :</p>
          {user.addresses.map((address, index) => (
            <div>
              ...
              <div className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200 mb-3">
